...
public class Dt1Controller {
    ...
    void btn_kaydet_Click(ActionEvent event) {
       sql="insert into dt1(hasta_TC,islem) values (?,?)";
    ...
    public void stage(String stageName) {
  		try {
  			...
  			stage1.show();
  			Stage stage2=(Stage) dt1Pane.getScene().getWindow();
  			stage2.close();
  		}
  		catch(Exception e) {
  			e.printStackTrace();
    ...
    void initialize() {
        ...
        liste=FXCollections.observableArrayList("Diş Çekimi","Kanal Tedavisi","Diş Beyazlatma","İmplant Uygulama");
